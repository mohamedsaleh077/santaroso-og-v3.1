CREATE TABLE IF NOT EXISTS `category` (
                                          ...
                                          `name` VARCHAR(255),
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP, -- مضافة
    PRIMARY KEY(`id`)
    );
...
CREATE TABLE IF NOT EXISTS `posts` (
    ...
    `body` TEXT(65535),
    `media` VARCHAR(255),
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP, -- مضافة (أساسية للترتيب)
    PRIMARY KEY(`id`),
...
CREATE TABLE IF NOT EXISTS `comments` (
    ...
    `body` TEXT(65535),
    `media` VARCHAR(255),
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP, -- مضافة (أساسية لآخر كومنت)
    PRIMARY KEY(`id`),
